...
docker exec -it pulsar bin/pulsar-admin topics create persistent://public/default/transactions
docker exec -it pulsar bin/pulsar-admin topics create persistent://public/default/accounts
...
docker exec -it pulsar bin/pulsar-admin topics set-retention -s -1 -t -1 persistent://public/default/accounts

docker exec -it pulsar bin/pulsar-admin topics get-retention persistent://public/default/customers
docker exec -it pulsar bin/pulsar-admin topics get-retention persistent://public/default/accounts
